...
A deterministic *Hanabi* bot that plays on the [hanab.live](https://hanab.live/) interface. Basic structure and ideas were taken from [Zamiell's example bot](https://github.com/Zamiell/hanabi-live-bot) (Python). Fork of my [original bot](https://github.com/will-hanabi-bot/hanabi-bot) (JavaScript), successor of the [Rust rewrite](https://github.com/will-hanabi-bot/rust-bot).

It can play with [Reactor 1.0](https://hanabi.wiki/conventions/reactor-1) (3p only), [Referential Sieve](https://hackmd.io/Ui6LXAK3TdC7AKSDcN20PQ?view) (with [special 2p](https://willflame14.github.io/rs-docs/)), or [H-Group](https://hanabi.github.io/) (up to level 12) conventions. Like my other bots, it does not do any "learning" during the game.
